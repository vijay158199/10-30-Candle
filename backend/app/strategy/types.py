...
class StructureType(str, Enum):
    # This strategy has exactly one structural concept - no BOS/CHOCH/MSS
    # continuation-vs-reversal distinction (that's an ICT concept the
    # sibling projects use; this one is just "the swing broke") - explicit
    # user spec (2026-08-29): "this strategy don't required bos and choch".
...
class EntryType(str, Enum):
    ...
    FAIR_VALUE_GAP = "FVG"
    # This project's own entry model: no retracement/zone - enters at the
    # open of the candle immediately following a confirmed swing break.
